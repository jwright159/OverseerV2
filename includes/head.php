<?php
// Bootstrap session, database, global state, etc.
// Implicitly starts session.
require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/bootstrap.php';

// If the user isn't logged in and isn't on one of these pages, send them back to `/`
...
$maintRow = mysqli_fetch_array(mysqli_query($connection, "SELECT * FROM `System` WHERE `Index` = '$system_index';"));
