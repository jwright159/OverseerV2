...
class SessionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Overseer.Models.Map.SessionTableMap';
     ...
     */
    const OM_CLASS = '\\Overseer\\Models\\Session';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Overseer.Models.Session';
     ...
     */
    const COL_ID = 'sessions.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'sessions.name';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Overseer\\Models\\Session');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Overseer\Models\Session) { // it's a model object
