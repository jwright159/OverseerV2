...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Overseer\\Models\\Map\\UserTableMap';
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Overseer\Models\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Overseer\Models\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Overseer\Models\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Overseer\Models\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function setCharacters(Collection $characters, ConnectionInterface $con = null)
    {
        ...
        foreach ($charactersToDelete as $characterRemoved) {
            $characterRemoved->setOwner(null);
        }
     ...
     * @return ObjectCollection|ChildCharacter[] List of ChildCharacter objects
     */
    public function getCharactersJoinSession(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCharacterQuery::create(null, $criteria);
