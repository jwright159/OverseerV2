...
abstract class Character implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Overseer\\Models\\Map\\CharacterTableMap';
    ...
    /**
     * The value for the chumhandle field.
     *
     * @var        string
     */
    ...
    /**
     * Initializes internal state of Overseer\Models\Base\Character object.
     */
    ...
    /**
     * Get the [chumhandle] column value.
     *
     * @return string
     */
    public function getChumhandle()
    {
        return $this->chumhandle;
    }
    ...
    public function setSpecies($v)
    {
        ...
        if ($this->species !== $v) {
            $this->species = $v;
            $this->modifiedColumns[CharacterTableMap::COL_SPECIES] = true;
        }
    ...
    /**
     * Set the value of [chumhandle] column.
     *
     * @param string $v new value
     * @return $this|\Overseer\Models\Character The current object (for fluent API support)
     */
    public function setChumhandle($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->chumhandle !== $v) {
            $this->chumhandle = $v;
            $this->modifiedColumns[CharacterTableMap::COL_CHUMHANDLE] = true;
        }
    ...
    public function setSessionId($v)
    {
        ...
        if ($this->session_id !== $v) {
            $this->session_id = $v;
            $this->modifiedColumns[CharacterTableMap::COL_SESSION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CharacterTableMap::translateFieldName('Species', TableMap::TYPE_PHPNAME, $indexType)];
            $this->species = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CharacterTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = CharacterTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Overseer\\Models\\Character'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CharacterTableMap::COL_SPECIES)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Overseer\Models\Character
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Overseer\Models\Character The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CharacterTableMap::COL_SPECIES)) {
            $criteria->add(CharacterTableMap::COL_SPECIES, $this->species);
        }
        if ($this->isColumnModified(CharacterTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Overseer\Models\Character (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Overseer\Models\Character Clone of current object.
     * @throws PropelException
     */
    ...
    public function getOwner(ConnectionInterface $con = null)
    {
        if ($this->aOwner === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOwner->addCharacters($this);
             */
        }
    ...
    public function getSession(ConnectionInterface $con = null)
    {
        if ($this->aSession === null && ($this->session_id !== null)) {
            $this->aSession = ChildSessionQuery::create()->findPk($this->session_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSession->addCharacters($this);
             */
        }
    ...
    {
        if (null !== $this->aOwner) {
            $this->aOwner->removeCharacter($this);
        }
        if (null !== $this->aSession) {
            $this->aSession->removeCharacter($this);
        }
        $this->id = null;
        $this->species = null;
        $this->name = null;
