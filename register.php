...
<div class="container">
    ...
    <form role="form" class="form-horizontal" id="RegisterForm" action="forms/addaccount.php" method="post">
        ...
        <br /><br />
        <div class="alert alert-warning" role="alert">Be advised: You'll be asked to confirm your email address, and it'll be needed if you ever need to reset your password. </div><br>
        <br>
    </form>
</div>
